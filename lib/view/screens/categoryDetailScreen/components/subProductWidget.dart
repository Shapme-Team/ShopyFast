...
class BottomSide extends StatelessWidget {
  ...
  Widget buildIncrementDecrement(BuildContext context) {
    return Container(
      child: Row(
        children: [
          quantityChangeW(IncrementDecrement.DECREMENT, context),
          Container(
            height: 40,
          ...
          quantityChangeW(IncrementDecrement.INCREMENT, context),
        ],
      ),
    );
  }

  Widget quantityChangeW(IncrementDecrement idValue, BuildContext context) {
    onTapFun() {
